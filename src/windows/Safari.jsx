    ...
    <div className="w-full h-full flex flex-col bg-[#f3f3f6] rounded-xl overflow-hidden font-sans select-none text-[#1d1d1f]">
      ...
      <div className="flex items-center px-4 h-12 bg-[#ececec] border-b border-[#dcdcdc] select-none shrink-0 relative">
        ...
        <div className="flex-1 max-w-[480px] mx-auto">
          <div className="flex items-center justify-center gap-1.5 bg-[#e1e1e4]/75 hover:bg-[#dbdbdf] focus-within:bg-white focus-within:shadow-[0_1px_3px_rgba(0,0,0,0.06)] focus-within:ring-[1px] focus-within:ring-blue-500/50 rounded-lg px-3 py-1.5 text-xs text-neutral-600 border border-black/[0.03] transition-all">
